...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(
    SHIFT(KC_8),   KC_7,    KC_8,    KC_9,    KC_0,            SHIFT(KC_BSLS), KC_LBRC,        KC_RBRC,        SHIFT(KC_6), SHIFT(KC_4),\
    SHIFT(KC_EQL), KC_4,    KC_5,    KC_6,    KC_GRAVE,        KC_BSLS,        SHIFT(KC_9),    SHIFT(KC_0),    SHIFT(KC_5), SHIFT(KC_7),\
    KC_EQL,        KC_1,    KC_2,    KC_3,    SHIFT(KC_GRAVE), SHIFT(KC_2),    SHIFT(KC_LBRC), SHIFT(KC_RBRC), SHIFT(KC_3), SHIFT(KC_1),\
    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS), \

  // 2: arrows and function keys
  KEYMAP(
     KC_INS,   KC_F7,    KC_F8,    KC_F9,    KC_F10,                       KC_HOME,  KC_RGHT,  KC_END,   KC_PGUP,  KC_NO, \
     KC_DEL,   KC_F4,    KC_F5,    KC_F6,    KC_F11,                       KC_LEFT,  KC_DOWN,  KC_UP,    KC_PGDN,  KC_NO, \
